...
export const services: Service[] = [
  ...
  },
  {
    ...
    stats: [
      { label: "UI Screens Designed", value: "100+" },
  ...
  },
  {
    ...
    stats: [
      { label: "SEO Campaigns", value: "10+" },
      { label: "Pages Optimized", value: "100+" },
      { label: "Client Satisfaction", value: "100%" },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "Infrastructure Setups", value: "15+" },
      { label: "Support Response", value: "<24h" },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: "Business Assessments", value: "15+" },
      { label: "Digital Roadmaps", value: "12+" },
      { label: "Client Satisfaction", value: "100%" },
    ],
